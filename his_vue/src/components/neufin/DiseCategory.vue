...
<template>
  <gao-el-container>
    ...
    <el-button type="primary" size="mini" style="margin-left: 10px" icon="el-icon-view" @click="searchClick">查询部门新聘员工报表</el-button>
  ...
  export default{
    methods: {
      ...
      loadBlogs(page, count){
        ...
        var url =this.rootUrl +"/neusys/diseCategory/all?page=" + page + "&count=" + count + "&keywords=" + this.keywords + "&keywords2=" + this.keywords2 + "&keywords3=" + this.keywords3  ;

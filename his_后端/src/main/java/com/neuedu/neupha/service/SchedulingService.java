...
public interface SchedulingService {
     ...
     * @return 记录数量  整型
     */ 
	int getSchedulingCount(String keywords, String keywords2,String keywords3);
...
*/
     ...
     * @return: 包含查询结果的Map集合
     */ 
	List<Map<String, Object>> getSchedulingList(Integer page, Integer count, String keywords, String keywords2,String keywords3);
